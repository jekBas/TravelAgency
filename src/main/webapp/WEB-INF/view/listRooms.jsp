...
<div id="banner"
    ...
    <div class="container">
        ...
        <table class="table table-dark table-hover">
            <thead>
            <tr>
                <th scope="col">this rooms are free in this hotel for this date</th>
            </tr>
            </thead>
        ...
        <div class="table table-dark table-striped"
            ...
            <table class="table table-dark table-hover">
                ...
                <c:forEach var="rooms" items="${rooms}">
                    ...
                    <c:url var="createOrder" value="${pageContext.request.contextPath}/order/order">
                        <c:param name="roomId" value="${rooms.id}"/>
                    </c:url>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10%">
                            <a href="${createOrder}" class="form-control btn" value="q"
